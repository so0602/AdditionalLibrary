...
APSPLITVIEWCONTROLLER_PATH=${STATICLIB}/APSplitViewController
if [ ! -e "$APSPLITVIEWCONTROLLER_PATH" ]; then
mkdir "$APSPLITVIEWCONTROLLER_PATH"
fi
cp APSplitViewController/*.h "$APSPLITVIEWCONTROLLER_PATH"
cp -R APSplitViewController/*.bundle "$APSPLITVIEWCONTROLLER_PATH"
